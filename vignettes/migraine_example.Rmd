---
title: "Migraine Discovery Workflow"
output: rmarkdown::html_vignette
author: "Chao Liu"
date: "`r Sys.Date()`"
vignette: >
  %\VignetteIndexEntry{Migraine Discovery Workflow}
...
knitr::include_graphics("../man/figures/migraine_heatmap.png")
```
```
plot_network(diverse_results, output_file = "migraine_network.png")
```
```{r, eval = TRUE, out.width = "600px", echo=FALSE}
knitr::include_graphics("../man/figures/migraine_network.png")
```
...
library(htmltools)
includeHTML("../man/figures/migraine_network.html")
```
...
```{r echo = FALSE, eval=TRUE, message=FALSE, warning=FALSE}
library(htmltools)
includeHTML("../man/figures/migraine_chord.html")
```
