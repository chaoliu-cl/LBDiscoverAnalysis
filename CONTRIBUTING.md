...
2. Install dependencies, including suggested packages for tests and docs.
...
3. Update documentation (`R/` roxygen comments and generated `man/*.Rd`) when public behavior changes.
4. Run:
...
3. Keep functions pure where possible and avoid unnecessary side effects.
